              ...
              <MapView
                ...
                <MapViewDirections
                  ...
                  onReady={(result) => {
                    ...
                    Toast.show({
                      type: "info",
                      text1: `Estimated time of delivery: ${result.duration.toFixed(2)} mins`,
                      position: "bottom",
                    ...
                    //   coordinate:
                    //     result.coordinates[result.coordinates.length - 1], // Display at the destination
                    //   title: `Distance: ${result.distance} km`,
                    //   description: `Duration: ${result.duration} min.`,
